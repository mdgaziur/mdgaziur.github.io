<script lang="ts">
	...
	// I am so sorry!
	let nav_button_status: boolean[] = [true, false, false, false, false, false];
...
<div class="sm:flex w-full overflow-y-hidden">
	...
	>
		...
		<NavButton is_selected={nav_button_status[0]} on_click={() => on_nav(0)} text="Home">
			<svg
				fill="none"
				height="35"
				viewBox="0 0 32 33"
		...
		<NavButton is_selected={nav_button_status[1]} on_click={() => on_nav(1)} text="About">
			<svg
				fill="none"
				height="35"
				viewBox="0 0 32 35"
		...
		<NavButton is_selected={nav_button_status[2]} on_click={() => on_nav(2)} text="Education">
			<svg
				fill="none"
				height="35"
				viewBox="0 0 48 49"
		...
		<NavButton is_selected={nav_button_status[3]} on_click={() => on_nav(3)} text="Achievements">
			<svg
				fill="none"
				height="35"
				viewBox="0 0 36 37"
		...
		<NavButton is_selected={nav_button_status[4]} on_click={() => on_nav(4)} text="Skills">
			<svg
				height="35"
		...
		<NavButton is_selected={nav_button_status[5]} on_click={() => on_nav(5)} text="Projects">
			<svg
				fill="none"
				height="35"
				viewBox="0 0 32 25"
	...
	<div class="flex-1 overflow-y-scroll max-h-screen" id="content">
		<div class="sticky top-0 p-10 flex flex-col items-center justify-center min-h-screen" id="home">
			<div class="flex flex-col gap-3">
				<h1>MD Gaziur Rahman Noor</h1>
				<h2>Student and Programmer</h2>
		...
		<div class="sticky top-0 backdrop-blur-xl" id="other-content-container">
			<div
			...
			>
				...
				<div class="flex flex-wrap justify-center sm:gap-10 gap-5 p-10 pl-0 pr-0">
					<SkillCard name="C">
						<svg height="40" viewBox="0 0 128 128" width="40">
							...
							<path d="M10.7 95.3c.5.8 1.2 1.5 1.9 1.9l48.2 27.9c.8.5 1.9.7 3.1.7 1.2 0 2.3-.3 3.1-.7l48-27.9c1.7-1 2.9-3.5 2.9-5.4V36.1c0-.9-.1-1.9-.6-2.8l-106.6 62z"
										fill="#03599C"></path>
							<path d="M85.3 76.1C81.1 83.5 73.1 88.5 64 88.5c-13.5 0-24.5-11-24.5-24.5s11-24.5 24.5-24.5c9.1 0 17.1 5 21.3 12.5l13-7.5c-6.8-11.9-19.6-20-34.3-20-21.8 0-39.5 17.7-39.5 39.5s17.7 39.5 39.5 39.5c14.6 0 27.4-8 34.2-19.8l-12.9-7.6z"
										fill="#fff"></path>
						</svg>
					</SkillCard>
					<SkillCard name="C++">
						<svg height="40" viewBox="0 0 128 128" width="40">
							<path d="M118.766 95.82c.89-1.543 1.441-3.28 1.441-4.843V36.78c0-1.558-.55-3.297-1.441-4.84l-55.32 31.94Zm0 0"
										fill="#00599c"></path>
							<path d="m68.36 126.586 46.933-27.094c1.352-.781 2.582-2.129 3.473-3.672l-55.32-31.94L8.12 95.82c.89 1.543 2.121 2.89 3.473 3.672l46.933 27.094c2.703 1.562 7.13 1.562 9.832 0Zm0 0"
										fill="#004482"></path>
							<path d="M118.766 31.941c-.891-1.546-2.121-2.894-3.473-3.671L68.359 1.172c-2.703-1.563-7.129-1.563-9.832 0L11.594 28.27C8.89 29.828 6.68 33.66 6.68 36.78v54.196c0 1.562.55 3.3 1.441 4.843L63.445 63.88Zm0 0"
										fill="#659ad2"></path>
					...
					<SkillCard name="Rust">
						<svg fill="white" height="40" viewBox="0 0 128 128" width="40">
							<path
					...
					<SkillCard name="NextJS">
						<svg height="40" viewBox="0 0 128 128" width="40">
							...
							<path d="M106.317 112.014 49.167 38.4H38.4v51.179h8.614v-40.24l52.54 67.884a64.216 64.216 0 0 0 6.763-5.209z"
										fill="url(#a)"></path>
							<path d="M81.778 38.4h8.533v51.2h-8.533z" fill="url(#b)"></path>
							<defs>
								<linearGradient gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" id="a" x1="109" x2="144.5" y1="116.5"
																y2="160.5">
									<stop stop-color="#fff"></stop>
									<stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
								</linearGradient>
								<linearGradient gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" id="b" x1="121" x2="120.799" y1="54"
																y2="106.875">
									<stop stop-color="#fff"></stop>
									<stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
								</linearGradient>
